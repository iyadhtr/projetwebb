...
<section>
				...
				<form action="maildeevent.php" method="POST">
					<h4 style="color:#5D4660;">adresse mail :</h4><br>
					<input type="text" name="mail" placeholder="votre adresse mail"><br><br>
		

	<h4 style="color:#5D4660;">votre texte : </h4>
			<input type="text" style=": 200px;" name="message" >
